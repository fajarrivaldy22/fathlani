...
<head>
  ...
  <link href="<? echo $this->load->view('admin/referenceAdmin/vendor/fontawesome-free/css/all.min.css');?>" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

  <!-- Custom styles for this template-->
  <link href="<? echo $this->load->view('admin/referenceAdmin/css/sb-admin-2.min.css');?>" rel="stylesheet">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php //require_once("buttons.php") ?>"; ?>">Buttons</a>
